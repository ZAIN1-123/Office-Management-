...
/*
The new class is called ViewSpecificly and it is based on JFrame
...
*/
public class ViewSpecificly extends javax.swing.JFrame {

Connection conn;
PreparedStatement pst;
ResultSet rs;
    public ViewSpecificly() {
        super("ViewSpecificly");
        initComponents();
        conn=javaconnect.ConnectDb();
        jTable1();
    }
/* table used to display the attendence according to the employee id and month and year
    */
    public void jTable1(){
        try{
        String sql = "select Department, ID, Month, Year, Status from `attendence` where ID=? and Month=? and Year=?";
...
/*initcomponents() is a method that NetBeans (I guess you are using it)
   swing Designer creates to initialise components (set default values etc.)*/
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(1261, 501));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try{
            pst=conn.prepareStatement("SELECT sum(Status) FROM attendence where ID=? and Month=? and Year=?");
            pst.setString(1, jTextField1.getText());
            pst.setString(2, (String) jComboBox1.getSelectedItem());
            pst.setString(3, (String) jComboBox2.getSelectedItem());
            rs=pst.executeQuery();
            if(rs.next()){
                String add1=rs.getString("sum(Status)");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewSpecificly().setVisible(true);
            }
        });
    }
