...
/*
The new class is called ViewLeave and it is based on JFrame
...
/* table used to display the leave taken by the employees*/
    public void jTable1(){
        try{
   ...
   /* another table used to display the leave of employees according to there id */
    public void jTable2(){
        try{
        String sql = "select ID, Department, Name, Leave_Type, No_Of_Days,  Leave_Start, Leave_End from leave_apply where ID=?";
        pst=conn.prepareStatement(sql);
