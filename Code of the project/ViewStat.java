...
/*
The new class is called ViewStat and it is based on JFrame
...
/* table used to display the statistics of an office 
    ...
    */
     ...
     /* another table used to display statistics of an office 
     according to the yaer */
    public void jTable2(){
        try{
...
/*initcomponents() is a method that NetBeans (I guess you are using it)
   swing Designer creates to initialise components (set default values etc.)*/
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(1279, 616));
